...
import depo1 from "../../assets/depoMentoria.jpeg";
import depo2 from "../../assets/lucieneMentoria.jpg";
import depo3 from "../../assets/mayaraMentoria.jpeg";
import depo4 from "../../assets/patriciaMentoria.jpeg";
    ...
    <section className={styles.depoimentosSection}>
      <div className={`container ${styles.depoimentosContainer}`}>
        <div className={styles.header}>
          ...
          <p>
            Acompanhe a experiência de quem já passou pelos meus atendimentos.
          </p>
        </div>
