...
import adnaSupervisao from '../assets/AdnaSupervisao.jpeg';
        ...
        <div className="container">
          ...
          >
            <div className={styles.serviceHeroText}>
              <span className={styles.eyebrow}>Mentoria & Orientação Clínica</span>
              <h1 className={styles.heroTitle}>Supervisão Clínica em Psicanálise e Mentoria para Psicólogas</h1>
              <p>
                Desenvolva uma prática ética, segura e uma carreira sólida na Psicologia Clínica.
              </p>
              <p>
                A Supervisão Clínica oferece um espaço de reflexão, estudo e elaboração da prática profissional, permitindo que a psicóloga desenvolva uma escuta ética, sensível e comprometida com a singularidade de cada paciente.
              </p>
            </div>

            <div className={styles.serviceHeroImage}>
              <img src={supervisaoImg} alt="Supervisão Clínica e Mentoria para Psicólogas" />
            </div>
          </motion.div>
